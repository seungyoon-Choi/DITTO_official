...
Code of TERACON: https://github.com/Sein-Kim/TERACON
"""
class ResidualBlock(nn.Module):
    ...
    def forward(self, x_): 
        ...
        # t = torch.LongTensor([t_]).to(device)
...
class NextItNet_Decoder(nn.Module):
    ...
    def __init__(self, model_para):
        ...
        self.task_classifier = nn.ModuleList([nn.Linear(self.residual_channels, self.residual_channels) for n in range(self.num_task)])
